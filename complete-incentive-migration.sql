-- Complete the film incentive tracking migration
-- Add the missing tables and data
...
LEFT JOIN analysis_location_matches alm ON sa.id = alm.analysis_id
GROUP BY sa.id, sa.title, sa.genre, sa.total_estimated_incentives, sa.incentive_analysis_complete;
